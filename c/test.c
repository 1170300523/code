 ...
 *function  : two classic search: binary search and BST search 
 * 
 */  
 #include <stdio.h>  
 #include <stdlib.h>  
 ...
 #define NUM 1024  
   
 /*the structure of BST node*/  
 struct bst_node  
 {  
     int data;  
     int position;/*search finished will return the position */  
     struct bst_node *left,*right;  
 };  
   
 /*binary search: input an array,and the size of the array,and a nunber you want 
 to search, the function will return the target's position in the array */  
